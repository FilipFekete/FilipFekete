...
Here are my four latest personal highlights:

### 1. Acquisitions - Production Back-end API 
* **Description:** A complete production ready back-end API with authentication, automated testing, containerization, and continuous integration pipelines.
* **Repository Link:** [https://github.com/FilipFekete/acquisitions]

### 2. AI Resume Analyzer - Web App
...
### 3. Electronic Nose - Embedded Smell Detection System
